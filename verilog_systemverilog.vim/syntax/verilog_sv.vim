...
" add by erik, from https://github.com/nachumk/systemverilog.vim/blob/master/syntax/systemverilog.vim (1.7)
...
if version >= 508 || !exists("did_verilog_syn_inits")
   ...
   " by erik, mark verilogOperator and verilogGlobal
...
" add by erik, from https://github.com/nachumk/systemverilog.vim/blob/master/syntax/systemverilog.vim (1.7)
  HiLink svInvPre none
  HiLink svPreProc PreProc
  HiLink svPreCondit PreCondit
  HiLink svInclude Include
  HiLink svDefine Define
  HiLink svInvSystemFunction none
  HiLink svSystemFunction Function
  "HiLink svObjectFunctions Function
  HiLink svOperator Operator
  HiLink svDelimiter Delimiter

   delcommand HiLink
endif

" by erik, rename verilog_systemverilog to verilog_sv
let b:current_syntax = "verilog_sv"
